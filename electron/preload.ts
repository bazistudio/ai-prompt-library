...
const api = {
  ...
  security: {
    ...
    removePin: (currentPinOrPassword: string) => ipcRenderer.invoke("security:removePin", currentPinOrPassword),
    removePassword: (currentPassword: string) => ipcRenderer.invoke("security:removePassword", currentPassword),
